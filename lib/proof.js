...
function execute (expected, cleanup1, setup, cleanup2, run) {
  var actual = 0
    , passed = 0
    , callbacks = { results: {} }
    , exitCode = 0
  ...
  cadence(function (step) {
    step(function () {
      ...
      return setup.apply(null, parameterize(setup, context));
    });
  }, function (object) {
  ...
  function main (error, context) {
    ...
    cadence(function (step) {
      context.step = step;
      step(function () {
        cleanup2.apply(null, parameterize(cleanup2, context));
      }, function () {
        run.apply(null, parameterize(run, context));
      }, function () {
        if (!untidy) {
          step(function () {
            cleanup2.apply(null, parameterize(cleanup2, context));
